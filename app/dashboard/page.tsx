...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      {!account?.is_connected ? (
        <div className="mx-auto mt-20 max-w-xl rounded-[28px] border border-white/[0.08] bg-[#0b0b0b] p-6 text-center sm:p-12 shadow-2xl shadow-black/30">
        ...
        <>
          ...
          <section className="mt-10">
            ...
            {posts.length === 0 ? (
              <div className="rounded-[24px] border border-white/[0.07] bg-[#0b0b0b] p-6 text-center sm:p-12">
