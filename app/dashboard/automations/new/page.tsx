...
export default async function NewAutomationPage({
  ...
  async function createAutomation(
    ...
    const followupDelayMinutes = Math.min(1380, Math.max(60, Number(
      formData.get("followup_delay_minutes") ?? 360
    ) || 360));

    const followupMessage =
      String(formData.get("followup_message") ?? "").trim();
            ...
            >
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Give this automation a name so you can easily identify it later from the Scheduler.
                </p>
                ...
                <p className="mt-2 text-xs text-gray-600">
                  Example: Course Launch, Webinar Leads, Product Enquiry
                </p>
...
https://example.com`}
              ...
              <div className="mt-6 rounded-2xl border border-white/[0.07] bg-white/[0.02] p-5">
                ...
                <label className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-gray-500">
                      We track clicks on your Custom DM Button. If it isn&apos;t clicked, send one reminder.
                    </p>
                  </div>
                ...
                <div className="mt-5 space-y-4">
                  <div>
                    <label htmlFor="followup_delay_minutes" className="mb-2 block text-sm font-medium">
                      Send reminder after
                    </label>
                    <select
                  ...
                  <div>
                    <label htmlFor="followup_message" className="mb-2 block text-sm font-medium">
                      Follow-up message
                    </label>
                    <textarea
                      id="followup_message"
                ...
                <p className="mt-3 text-[11px] leading-5 text-gray-600">
                  Link tracking works with the Custom DM Button URL. Keep the reminder within Instagram&apos;s messaging window.
                </p>
              </div>
